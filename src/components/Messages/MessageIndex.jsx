                            ...
                            <>
                              {chatMessage.from_user_id ==
                                  ...
                                  <div className="chat-message-wrapper">
                                    <div className="chat-message-content">
                                      {chatMessage.message_type == 'text' ?
                                        ...
                                        : (chatMessage.message_type == 'image') ? (<Image src={((chatMessage.from_user) ? (api.serviceUrl() + '/' + chatMessage.message) : chatMessage.file)} className="mine"/>) : ((chatMessage.message_type == 'video') ? (<ReactPlayer
                                ...
                                <div className="chat-message chat-message-recipient">
                                  ...
                                  <div className="chat-message-wrapper">
                                    <div className="chat-message-content" style={{background:"rgb(232 93 190 / 39%)"}}>
                                      {chatMessage.message_type == 'text' ?
                                        (<p>{chatMessage.message}</p>)
                                        : (chatMessage.message_type == 'image') ? (<Image src={((chatMessage.from_user) ? (api.serviceUrl() + '/' + chatMessage.message) : chatMessage.file)} className="mine" />) : ((chatMessage.message_type == 'video') ? (<ReactPlayer
                                          light={(api.serviceUrl() + '/' + chatMessage.thumbnail)}
